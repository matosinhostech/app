...
const Events = ({item}) => {
  ...
  const handleModal = () => setAlertModal(() => !alertModal); 
    ...
    return (<>
            ...
            <InnerContainer>
              ...
              <Card>
                ...
                Subscribe to our news and next events!
                </Text>
                ...
                <StyledButtonEvent onPress={handleModal}> 
                  ...
                  <Text style={{fontFamily: 'monospace', textAlign: "center", paddingBottom: 20, fontSize: 15}}>
                  Your email was added to our list! You will receive a notification soon.
                  </Text>


                  <Button title="Dismiss" onPress={handleModal} color={'red'} />
